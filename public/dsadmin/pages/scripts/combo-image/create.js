...
$("#combo_image").on('change',function(event){
	...
	if(jquery_count <= image_count){
		...
		$("#label-combo-image").append("<span id='error-image' style='color: red; font-size: 12px;'>No puedes selecionar más de "+image_count+" imagenes</span>");
	}
