...
@section('scripts')
  ...
  <script src="{{asset('dsadmin/pages/scripts/base-image/edit.js')}}"></script>
...
@section('styles')
  ...
  <link href="{{asset("dsadmin/plugins/bootstrap-fileinput/css/fileinput.min.css")}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset("dsadmin/pages/css/base-image/edit.css")}}" rel="stylesheet" type="text/css"/>
...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title"><strong>Editar esta imagen de la {{$base->base->base_name}}</strong></h3>
      <div class="float-sm-right">
        <a href="{{route('base-index')}}">Listado</a> / <a class="active">Editar Imagen</a>
      </div>  
    </div>
    <div class="card-body">
      ...
      <div class="row">
          ...
          <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" class="col-md-12" method="POST" action="{{route('base-image-update', ['base_image_id' => $base_image_id])}}" id="form-general">
                @csrf @method("put")
                <div class="card-body">                                                      
                        ...
                        <div class="col-md-4 text-center">
                            <div class="kv-base">
                                <div class="file-loading">
                                    <input id="base_image" name="base_image" type="file">
                                </div>
                            </div>
                            <div class="kv-base-hint">
                                <small>Selecciona la imagen de la base, si deseas cambiarla</small>
                            </div>
                        </div>
