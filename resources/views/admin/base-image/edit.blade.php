  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="row">
          ...
          <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" class="col-md-12" method="POST" action="{{route('base-image-update', ['base_image_name' => $base_image_name])}}" id="form-general">
                @csrf @method("put")
                <div class="card-body">                                                      
                    <div class="row form-group justify-content-center">
                      <div class="col-md-2">
                        <div class="product-image-thumb"><img src="{{Storage::url("images/bases/".$base_image_name)}}" alt="Product Image"></div>
                      </div>
                      <div class="row col-md-10">
                        <label for="exampleInputFile">Selecciona otra imagen si la deseas cambiar</label>
                        <div class="input-group col-md-11">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" name="base_image" id="exampleInputFile">
