...
@section('styles')
  ...
  <link href="{{asset("dsadmin/pages/css/base-image/create.css")}}" rel="stylesheet" type="text/css"/>
...
@php
 ...
 @endphp
  ...
  <div class="card card-primary">
    ...
    @else
    	<h3 class="card-title"><small>Agrega las {{$add_img}} imagenes de la <strong>{{$base->base_name}}</strong> que hacen falta o tambien puedes agregar solo una</small></h3>
    @endif  
    ...
    <div class="card-body">
      ...
      <div class="row">
          ...
          <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="form-general" enctype="multipart/form-data" class="col-md-12" method="POST" action="{{route('base-image-store')}}" >
                @csrf
                <div class="card-body">                                                      
                  <div class="row form-group justify-content-center">
                      <div class="col-md-12">
                        ...
                        <input id="input-24" name="base_image[]" type="file" multiple required>
                      </div>
                  </div>
