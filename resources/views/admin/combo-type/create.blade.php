...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title"><strong>Crear Tipo de combo</strong></h3>
      <div class="float-sm-right">
        <a href="{{route('combo-type-index')}}">Listado</a> / <a class="active">Crear</a>
      </div>  
    </div>
    <div class="card-body">
      ...
      <div class="row">
          ...
          <div class="col-md-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" class="col-md-12" method="POST" action="{{route('combo-type-store')}}" id="form-general">
                @csrf
                <div class="card-body">
                    <div class="row form-group">
                      <div class="col col-md-12">
                        <label for="exampleInputEmail1">Nombre</label>
                        <input type="text" name="combo_type_name" class="form-control" id="combo_type_name" placeholder="Nombre del tipo de combo" value="{{old('combo_type_name')}}" autocomplete="off" required>
                      </div>
                    </div>
                 </div>   
