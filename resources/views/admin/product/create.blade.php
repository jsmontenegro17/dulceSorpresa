                ...
                <div class="card-body">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col col-md-6">
                        ...
                        <textarea id="product_description" name="product_description" class="form-control lowercase" placeholder="Sabor, medida o cantidad" required>{{old('product_description')}}</textarea>
                      </div>                     
                    </div>                                                          
                    <div class="row form-group">
                      <div class="col-md-3">
